...
ActiveRecord::Schema[8.1].define(version: 2026_02_11_214201) do
  ...
  create_table "plans", force: :cascade do |t|
    ...
    t.integer "included_seats", default: 1, null: false
    t.integer "included_workspaces", default: 0, null: false
    t.string "name", null: false
