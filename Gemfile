...
# (activeagents/activeagent#479 and #482, which build on main past the 1.6.2
# release line). Move both pins back to a release branch or tag once those
# merge and ship.
gem "activeagent", github: "activeagents/activeagent", branch: "claude/claude-code-connection-478"
# Action Agent - the dashboard, a mountable Rails engine. Lives in the same
# repo as a sibling gem, hence the glob.
gem "actionagent", github: "activeagents/activeagent", branch: "claude/claude-code-connection-478", glob: "actionagent/*.gemspec"
