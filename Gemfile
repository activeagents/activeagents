...
# Pinned to the 1.6.2 release line (activeagents/activeagent#455), which
# carries the dashboard API hardening #132 depends on; move both pins to the
# released version once the tag is cut.
gem "activeagent", github: "activeagents/activeagent", branch: "release/1.6.2"
# Action Agent - the dashboard, a mountable Rails engine. Lives in the same
# repo as a sibling gem, hence the glob.
gem "actionagent", github: "activeagents/activeagent", branch: "release/1.6.2", glob: "actionagent/*.gemspec"
